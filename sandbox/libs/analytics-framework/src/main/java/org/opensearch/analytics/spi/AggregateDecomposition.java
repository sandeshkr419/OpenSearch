...
public interface AggregateDecomposition {
     ...
     * @param input the input RelNode, used for type inference
     */
    List<AggregateCall> partialCalls(AggregateCall originalCall, org.apache.calcite.rel.RelNode input);
     ...
     * referencing the columns emitted by {@link #partialCalls(AggregateCall, org.apache.calcite.rel.RelNode)} in order.
     *
