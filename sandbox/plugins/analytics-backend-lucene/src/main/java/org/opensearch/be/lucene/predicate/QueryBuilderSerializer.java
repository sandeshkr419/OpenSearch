 ...
 * plus built-in entries for fallback types like {@link MatchAllQueryBuilder}.
 */
public class QueryBuilderSerializer {
    ...
    static {
        List<NamedWriteableRegistry.Entry> entries = new ArrayList<>(PredicateHandlerRegistry.allNamedWriteableEntries());
        entries.add(new NamedWriteableRegistry.Entry(QueryBuilder.class, MatchAllQueryBuilder.NAME, MatchAllQueryBuilder::new));
        REGISTRY = new NamedWriteableRegistry(entries);
    }
