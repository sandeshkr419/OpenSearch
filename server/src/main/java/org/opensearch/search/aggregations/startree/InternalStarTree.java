...
public class InternalStarTree<B extends InternalStarTree.Bucket,
    R extends InternalStarTree<B, R>> extends InternalMultiBucketAggregation<R, B> {

    static final InternalStarTree.Factory FACTORY = new InternalStarTree.Factory();

    public static class Bucket extends InternalMultiTerms.InternalBucket {
        public double sum;
        ...
        public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
            ...
            boolean hasValue = !Double.isInfinite(sum);
            builder.field(CommonFields.VALUE.getPreferredName(), hasValue ? sum : null);
    ...
    public InternalAggregation reduce(List<InternalAggregation> aggregations, ReduceContext reduceContext) {
        ...
        for (InternalAggregation aggregation : aggregations) {
            ...
            for (B bucket : filters.ranges) {
                ...
                List<B> sameRangeList = bucketsMap.computeIfAbsent(key, k -> new ArrayList<>(aggregations.size()));
        ...
        reducedBuckets.sort(Comparator.comparing(Bucket::getKey));
