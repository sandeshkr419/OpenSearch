...
public class StarTreeMapperTests extends MapperTestCase {
    ...
    public void testValidStarTreeDateDims() throws IOException {
        ...
        for (CompositeMappedFieldType type : compositeFieldTypes) {
            ...
            expectedMetrics = Arrays.asList(MetricStat.AVG, MetricStat.VALUE_COUNT, MetricStat.SUM, MetricStat.MAX, MetricStat.MIN);
    ...
    public void testInvalidMetricTypeWithDocCount() {
        MapperParsingException ex = expectThrows(
            MapperParsingException.class,
            () -> createMapperService(getInvalidMapping(false, false, false, false, false, false, true))
        );
    ...
    public void testInvalidDateDimType() {
        MapperParsingException ex = expectThrows(
            MapperParsingException.class,
            () -> createMapperService(getInvalidMapping(false, false, true, false, false, true, false))
        );
        assertEquals(
