...
public class CompositeAggregatorTests extends AggregatorTestCase {
    ...
    protected Codec getCodec() {
        final Logger testLogger = LogManager.getLogger(CompositeAggregatorTests.class);
    ...
    public void testCompositeWithStarTree() throws IOException {
        ...
        // Test Case 1: Simple 2-source composite aggregation
        testCase(
            indexSearcher,
            new MatchAllDocsQuery(),
            null,
            new CompositeAggregationBuilder("_name", getSources(KEYWORD_FIELD, INT_FIELD)),
            starTree,
            supportedDimensions
        );

        // Test Case 2: 3-source composite aggregation
        testCase(
            indexSearcher,
            new MatchAllDocsQuery(),
            null,
            new CompositeAggregationBuilder("_name", getSources(KEYWORD_FIELD, INT_FIELD, FLOAT_FIELD)),
            starTree,
            supportedDimensions
        );
        ...
        testCase(
            ...
            new CompositeAggregationBuilder("_name", getSources(INT_FIELD, FLOAT_FIELD)),
            starTree,
            supportedDimensions
        );
        ...
        testCase(
            ...
            new MatchAllDocsQuery(),
            null,
            new CompositeAggregationBuilder("_name", getSources(KEYWORD_FIELD, FLOAT_FIELD)).subAggregation(
                max("max_metric").field(METRIC_FIELD)
            ),
            starTree,
            supportedDimensions
        );
    ...
    private void testCase(
        ...
        InternalComposite starTreeAggregation = searchAndReduceStarTree(
            createIndexSettings(),
            indexSearcher,
            query,
            queryBuilder,
        ...
        InternalComposite defaultAggregation = searchAndReduceStarTree(
            createIndexSettings(),
            indexSearcher,
            query,
            queryBuilder,
    ...
    private List<CompositeValuesSourceBuilder<?>> getSources(String... fieldNames) {
